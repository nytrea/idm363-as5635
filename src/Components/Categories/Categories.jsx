    ...
    <div className='categories-container'>
        ...
        <div className='categories-links-container'>
            <div className='category-button'>
                <img src={aromatherapy} alt="category-btn" className="category-image"/>
                <h1 className='btn-name'>Aromatherapy</h1>

            </div>

            <div className='category-button'>
                <img src={stationery} alt="category-btn" className="category-image"/>
                <h1 className='btn-name'> Stationery</h1>

            </div>

            <div className='category-button'>
                <img src={kitchenware} alt="category-btn" className='category-image'/>
